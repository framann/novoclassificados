                        ...
                        <?php foreach ($master as $master): ?>
                          ...
                          <tr>
                            ...
                            <td>
                              ...
                              <a data-toggle="tooltip" data-placement="top" title="excluir" href="<?php echo base_url('restrita/' . $this->router->fetch_class() . '/delete/' . $master->categoria_pai_id); ?>" class="btn btn-warning delete" data-confirm="Tem certeza da exclusão do registro?"><i class="fas fa-trash-alt"></i></a>
                            </td>
                          </tr>
